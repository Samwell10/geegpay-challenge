...
const Sidebar = ({isopen, modetoggle,isdarkmode}) => {
    ...
    return ( 
        <div className={`${isopen ? "sidebar" : "sidebar-mobile"}`}>
            <div className="logo-container">
                <img src={logo} alt="Logo Geegpay" />
            </div>
            
            <div className={`nav-container ${isdarkmode?"nav-container-dark":"nav-container"}`}>
                <nav>
                    <ul>
                        <li className={`${isdarkmode ? "active-li-dark":"active-li"}`}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                <path d="M7.24 2H5.34C3.15 2 2 3.15 2 5.33V7.23C2 9.41 3.15 10.56 5.33 10.56H7.23C9.41 10.56 10.56 9.41 10.56 7.23V5.33C10.57 3.15 9.42 2 7.24 2Z" fill={isdarkmode ?"#B2ABAB":"#0D062D"}/>
                                <path opacity="0.4" d="M18.6699 2H16.7699C14.5899 2 13.4399 3.15 13.4399 5.33V7.23C13.4399 9.41 14.5899 10.56 16.7699 10.56H18.6699C20.8499 10.56 21.9999 9.41 21.9999 7.23V5.33C21.9999 3.15 20.8499 2 18.6699 2Z" fill={isdarkmode ?"#B2ABAB":"#0D062D"}/>
                                <path d="M18.6699 13.4301H16.7699C14.5899 13.4301 13.4399 14.5801 13.4399 16.7601V18.6601C13.4399 20.8401 14.5899 21.9901 16.7699 21.9901H18.6699C20.8499 21.9901 21.9999 20.8401 21.9999 18.6601V16.7601C21.9999 14.5801 20.8499 13.4301 18.6699 13.4301Z" fill={isdarkmode ?"#B2ABAB":"#0D062D"}/>
                                <path opacity="0.4" d="M7.24 13.4301H5.34C3.15 13.4301 2 14.5801 2 16.7601V18.6601C2 20.8501 3.15 22.0001 5.33 22.0001H7.23C9.41 22.0001 10.56 20.8501 10.56 18.6701V16.7701C10.57 14.5801 9.42 13.4301 7.24 13.4301Z" fill={isdarkmode ?"#B2ABAB":"#0D062D"}/>
                            </svg>
                        </li>
                        <li>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className="theme-mode">
                    <div className={mode ? "non-active" : "active"} onClick={()=>{
                        handleMode();
                        modetoggle();
                    }}>
                        <IoMdSunny />
                    </div>
                    <div className={mode ? "active" : "non-active"} onClick={()=>{
                        handleMode();
                        modetoggle();
                    }}>
                        <BsMoonStarsFill />
